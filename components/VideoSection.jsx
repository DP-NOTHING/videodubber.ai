    ...
    <div>
      <div className="mx-auto justify-between max-w-screen-xl px-4 py-8 sm:px-6 sm:py-8 lg:px-8 grid lg:grid-cols-5">
        <div className="text-center lg:text-left lg:mt-12 col-span-3">
          ...
          <p className="mt-4 lg:text-xl/relaxed">{data.description}</p>

          <div className="mt-8 flex flex-wrap gap-4 text-center justify-center lg:justify-start">
            <button
              onClick={() => (window.location = data.button1.url)}
            ...
            <button
              onClick={() => (window.location = data.button2.url)}
        ...
        <div
          className="hidden rounded-lg mt-10 sm:mt-14 md:mt-8 lg:mt-0 aspect-video lg:inline-flex text-right lg:mr-12 lg:ml-4 col-span-2"
          style={{ margin: 0 }}
        >
          <NewShowcase />
        </div>
