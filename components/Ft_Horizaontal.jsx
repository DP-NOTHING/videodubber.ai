...
{/* <div class="grid gap-8 row-gap-5 lg:grid-cols-3">
      ...
      <div class="relative p-5 bg-white rounded-sm">
        <div class="flex flex-col mb-2 lg:items-center lg:flex-row">
          <div class="flex items-center justify-center w-10 h-10 mb-4 mr-2 rounded-full bg-indigo-50 lg:mb-0">
              <svg xmlns="https://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-badge-cc" viewBox="0 0 16 16">
          ...
          <h3 class="font-semibold leading-5 text-base">Sub like a Pro</h3>
        </div>
        <p class="mb-2 text-sm text-gray-900">
          Get your auto-generated video subtitles for any language, edit on the go with your own dictionary and download with VideoDubber!</p>
          <p class="mb-2 text-sm text-gray-900">
          Proven way to 2x your video reach!
        </p>
        <a href="/translate-spanish-video-to-english/" aria-label="Learn how" class="inline-flex items-center text-sm font-semibold transition-colors duration-200 text-indigo-700 hover:text-indigo-900">Learn how</a>
      </div>
    </div>
    <div class="relative p-px overflow-hidden transition duration-300 transform border rounded shadow-sm hover:scale-105 group hover:shadow-xl">
      <div class="absolute bottom-0 left-0 w-full h-1 duration-300 origin-left transform scale-x-0 bg-deep-purple-accent-400 group-hover:scale-x-100"></div>
      ...
      <div class="relative p-5 bg-white rounded-sm">
        <div class="flex flex-col mb-2 lg:items-center lg:flex-row">
          <div class="flex items-center justify-center w-10 h-10 mb-4 mr-2 rounded-full bg-indigo-50 lg:mb-0">
              <svg xmlns="https://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-megaphone" viewBox="0 0 16 16">
          ...
          <h3 class="font-semibold leading-5 text-base">Dub like a Pro</h3>
        </div>
        <p class="mb-2 text-sm text-gray-900">
          Get advantage over your competitors making your video speak languages your subscribers understand but you don't, with VideoDubber!</p>
          
          <p class="mb-2 text-sm text-gray-900">
          Proven way to 10x your subscriber count!
        </p>
        <a href="/translate-spanish-video-to-english/" aria-label="Learn how" class="inline-flex items-center text-sm font-semibold transition-colors duration-200 text-indigo-700 hover:text-indigo-900">Learn how</a>
      </div>
    </div>
    <div class="relative p-px overflow-hidden transition duration-300 transform border rounded shadow-sm hover:scale-105 group hover:shadow-xl">
      ...
      <div class="relative p-5 bg-white rounded-sm">
        <div class="flex flex-col mb-2 lg:items-center lg:flex-row">
          <div class="flex items-center justify-center w-10 h-10 mb-4 mr-2 rounded-full bg-indigo-50 lg:mb-0">
              <svg xmlns="https://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-translate" viewBox="0 0 16 16">
          ...
          <h3 class="font-semibold leading-5 text-base">Translate like a Pro</h3>
        </div>
        <p class="mb-2 text-sm text-gray-900">
          Keep the original audio to embed translated subtitlesto reach new audience across platforms with VideoDubber! </p>
        <p class="mb-2 text-sm text-gray-900">
          Proven way to 10x your viewer count!
        </p>
        <a href="/translate-spanish-video-to-english/" aria-label="Learn how" class="inline-flex items-center text-sm font-semibold transition-colors duration-200 text-indigo-700 hover:text-indigo-900">Learn how</a>
      </div>
    </div>
        ...
        <div className="relative p-5 bg-white rounded-sm">
          <div className="flex flex-col mb-2 lg:items-center lg:flex-row">
            <div className="flex items-center justify-center w-10 h-10 mb-4 mr-2 rounded-full bg-indigo-50 lg:mb-0">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-badge-cc" viewBox="0 0 16 16">
                <path d="M3.708 7.755c0-1.111.488-1.753 1.319-1.753.681 0 1.138.47 1.186 1.107H7.36V7c-.052-1.186-1.024-2-2.342-2C3.414 5 2.5 6.05 2.5 7.751v.747c0 1.7.905 2.73 2.518 2.73 1.314 0 2.285-.792 2.342-1.939v-.114H6.213c-.048.615-.496 1.05-1.186 1.05-.84 0-1.319-.62-1.319-1.727v-.743zm6.14 0c0-1.111.488-1.753 1.318-1.753.682 0 1.139.47 1.187 1.107H13.5V7c-.053-1.186-1.024-2-2.342-2C9.554 5 8.64 6.05 8.64 7.751v.747c0 1.7.905 2.73 2.518 2.73 1.314 0 2.285-.792 2.342-1.939v-.114h-1.147c-.048.615-.497 1.05-1.187 1.05-.839 0-1.318-.62-1.318-1.727v-.743z"></path>
                <path d="M14 3a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h12zM2 2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H2z"></path>
              </svg>
            </div>
            <h3 className="font-semibold leading-5 text-base">{data.card[0].heading}</h3>
          </div>
          <p className="mb-2 text-sm text-gray-900">
            {data.card[0].text}
          </p>
          <a href={data.card[0].url} aria-label={data.card[0].label} className="inline-flex items-center text-sm font-semibold transition-colors duration-200 text-indigo-700 hover:text-indigo-900">
            {data.card[0].label}
          </a>
        </div>
      </div>
      ...
      <div className="relative p-px overflow-hidden transition duration-300 transform border rounded shadow-sm hover:scale-105 group hover:shadow-xl">
        <div className="relative p-5 bg-white rounded-sm">
          <div className="flex flex-col mb-2 lg:items-center lg:flex-row">
            ...
            <h3 className="font-semibold leading-5 text-base">{data.card[1].heading}</h3>
          </div>
          <p className="mb-2 text-sm text-gray-900">
            {data.card[1].text}
          </p>
          <a href={data.card[1].url} aria-label={data.card[1].label} className="inline-flex items-center text-sm font-semibold transition-colors duration-200 text-indigo-700 hover:text-indigo-900">
            {data.card[1].label}
          </a>
        </div>
      </div>
          ...
          <div className="flex flex-col mb-2 lg:items-center lg:flex-row">
            <div className="flex items-center justify-center w-10 h-10 mb-4 mr-2 rounded-full bg-indigo-50 lg:mb-0">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-translate" viewBox="0 0 16 16">
                <path d="M4.545 6.714 4.11 8H3l1.862-5h1.284L8 8H6.833l-.435-1.286H4.545zm1.634-.736L5.5 3.956h-.049l-.679 2.022H6.18z"></path>
                <path d="M0 2a2 2 0 0 1 2-2h7a2 2 0 0 1 2 2v3h3a2 2 0 0 1 2 2v7a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2v-3H2a2 2 0 0 1-2-2V2zm2-1a1 1 0 0 0-1 1v7a1 1 0 0 0 1 1h7a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H2zm10 5H9v7a1 1 0 0 0 1 1h3a1 1 0 0 0 1-1V6a1 1 0 0 0-1-1zm-5.387 6.468-1.102 1.48c-.07.1.01.22.127.22h.574c.072 0 .14-.034.182-.091l.742-.988.742.988a.23.23 0 0 0 .182.091h.574c.117 0 .197-.12.127-.22l-1.102-1.48.995-1.334a.162.162 0 0 0-.128-.254h-.543a.188.188 0 0 0-.151.078l-.63.84-.63-.84a.188.188 0 0 0-.151-.078h-.543a.162.162 0 0 0-.128.254l.995 1.334z"></path>
              </svg>
            </div>
            <h3 className="font-semibold leading-5 text-base">{data.card[2].heading}</h3>
          </div>
          <p className="mb-2 text-sm text-gray-900">
            {data.card[2].text}
          </p>
          <a href={data.card[2].url} aria-label={data.card[2].label} className="inline-flex items-center text-sm font-semibold transition-colors duration-200 text-indigo-700 hover:text-indigo-900">
            {data.card[2].label}
          </a>
        </div>
      </div>
